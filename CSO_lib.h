...
#define SMP			3		    // The maximum contineuously stay and view times.
#define SRD		  0.1     // The persentage of the perturbation on the selected dimensions in the "Tracing" mode.
#define CDC			1     // Mutation Range form this point to the other.
...
#define C1      2.05     // Parameter for the velocity
...
#define MR			0.5	  // The ratio of cats in the "Seeking" mode.
